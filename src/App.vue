    ...
    <div class="p-4 p-md-5 mb-4 rounded bg-body-secondary">
      <div class="row d-flex justify-content-evenly">
        <div class="col-lg-10">
          ...
          <p class="lead my-2 pe-4">本竞赛以净化社交媒体平台为出发点，首先进行社交媒体平台虚假账号检测，避免大量虚假账号传播虚假信息影响网络空间环境，进一步挖掘网络热点件中的观点片段，分析理解群体用户的情感倾向与会话关系，最终实现群体会话场景下的高质量会话内容生成，利用群体智能为社交媒体平台提供高质量信息，促进群体智能在社交媒体领域的产业应用与健康发展。</p>
